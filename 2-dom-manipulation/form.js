...
function validateForm(event) {
    ...
    let courses = Array.isArray(validateCourses(form_data.courses));
    if (name && email && phone && courses) {
        showFinalInfoIfAllIsCorrect();
        classes.INFO_PARAGRAPH.forEach(pa => pa.classList.remove('information-p'));
    }
    else {
